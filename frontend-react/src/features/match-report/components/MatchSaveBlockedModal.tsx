...
export interface MatchSaveBlockedModalProps {
  readonly open: boolean
  readonly issues: readonly MatchValidationIssue[]
  readonly onDismiss: () => void
}

export function MatchSaveBlockedModal({ open, issues, onDismiss }: MatchSaveBlockedModalProps) {
  return (
    <MatchDialogShell
      open={open}
      titleId="save-blocked-title"
    ...
    >
      <p className="text-sm text-slate-700">Revise lo siguiente antes de guardar:</p>
